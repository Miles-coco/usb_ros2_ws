...
#include "usb_device_driver/msg/detail/motors_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.target_velocities;
  }
  // Member: target_torques
  {
    cdr << ros_message.target_torques;
  }
  // Member: kp
  {
    cdr << ros_message.kp;
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 12;
    size_t item_size = sizeof(ros_message.target_velocities[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: target_torques
  {
    size_t array_size = 12;
    size_t item_size = sizeof(ros_message.target_torques[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: kp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = usb_device_driver::msg::MotorsCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const usb_device_driver::msg::MotorsCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<usb_device_driver::msg::MotorsCmd *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MotorsCmd__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const usb_device_driver::msg::MotorsCmd *>(
...
static size_t _MotorsCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotorsCmd(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MotorsCmd__callbacks = {
...
static rosidl_message_type_support_t _MotorsCmd__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MotorsCmd__callbacks,
...
{
  return &usb_device_driver::msg::typesupport_fastrtps_cpp::_MotorsCmd__handle;
}
