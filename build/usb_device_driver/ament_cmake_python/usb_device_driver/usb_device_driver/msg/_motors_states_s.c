...
bool usb_device_driver__msg__motors_states__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("usb_device_driver.msg._motors_states.MotorsStates", full_classname_dest, 49) == 0);
  }
  usb_device_driver__msg__MotorsStates * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // positions
    ...
    }
    {
      ...
      Py_ssize_t size = 12;
      float * dest = ros_message->positions;
      for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // torques
    ...
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT32);
      Py_ssize_t size = 12;
      float * dest = ros_message->torques;
      for (Py_ssize_t i = 0; i < size; ++i) {
        float tmp = *(npy_float32 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(float));
      }
  ...
  {  // statuses
    ...
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_UINT8);
      Py_ssize_t size = 12;
      uint8_t * dest = ros_message->statuses;
      for (Py_ssize_t i = 0; i < size; ++i) {
        uint8_t tmp = *(npy_uint8 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(uint8_t));
      }
...
{
  /* NOTE(esteve): Call constructor of MotorsStates */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("usb_device_driver.msg._motors_states");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MotorsStates");
  ...
  {  // positions
    ...
    float * src = &(ros_message->positions[0]);
  ...
  {  // torques
    ...
    assert(sizeof(npy_float32) == sizeof(float));
    npy_float32 * dst = (npy_float32 *)PyArray_GETPTR1(seq_field, 0);
    float * src = &(ros_message->torques[0]);
    memcpy(dst, src, 12 * sizeof(float));
    Py_DECREF(field);
  }
  {  // temperatures
  ...
  {  // statuses
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "statuses");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_uint8) == sizeof(uint8_t));
    npy_uint8 * dst = (npy_uint8 *)PyArray_GETPTR1(seq_field, 0);
    uint8_t * src = &(ros_message->statuses[0]);
    memcpy(dst, src, 12 * sizeof(uint8_t));
    Py_DECREF(field);
  }
