...
static const _IMUData_type_support_symbol_names_t _IMUData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, usb_device_driver, msg, IMUData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, usb_device_driver, msg, IMUData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, usb_device_driver, msg, IMUData)() {
  return &::usb_device_driver::msg::rosidl_typesupport_c::IMUData_message_type_support_handle;
}
