...
#ifndef USB_DEVICE_DRIVER__MSG__DETAIL__IMU_DATA__TRAITS_HPP_
#define USB_DEVICE_DRIVER__MSG__DETAIL__IMU_DATA__TRAITS_HPP_
...
inline void to_yaml(
  const usb_device_driver::msg::IMUData & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const usb_device_driver::msg::IMUData & msg)
{
  return usb_device_driver::msg::to_yaml(msg);
}

template<>
inline const char * data_type<usb_device_driver::msg::IMUData>()
{
  return "usb_device_driver::msg::IMUData";
}

template<>
inline const char * name<usb_device_driver::msg::IMUData>()
{
  return "usb_device_driver/msg/IMUData";
}

template<>
struct has_fixed_size<usb_device_driver::msg::IMUData>
...
template<>
struct has_bounded_size<usb_device_driver::msg::IMUData>
...
template<>
struct is_message<usb_device_driver::msg::IMUData>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // USB_DEVICE_DRIVER__MSG__DETAIL__IMU_DATA__TRAITS_HPP_
