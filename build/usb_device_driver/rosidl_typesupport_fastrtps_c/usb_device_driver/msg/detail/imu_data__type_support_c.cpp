...
#include "usb_device_driver/msg/detail/imu_data__rosidl_typesupport_fastrtps_c.h"
...
using _IMUData__ros_msg_type = usb_device_driver__msg__IMUData;
...
size_t get_serialized_size_usb_device_driver__msg__IMUData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _IMUData__ros_msg_type * ros_message = static_cast<const _IMUData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _IMUData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_usb_device_driver__msg__IMUData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_usb_device_driver
size_t max_serialized_size_usb_device_driver__msg__IMUData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = usb_device_driver__msg__IMUData;
    is_plain =
      (
...
static size_t _IMUData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_usb_device_driver__msg__IMUData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, usb_device_driver, msg, IMUData)() {
