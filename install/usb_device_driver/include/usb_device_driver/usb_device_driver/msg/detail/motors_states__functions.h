...
#ifndef USB_DEVICE_DRIVER__MSG__DETAIL__MOTORS_STATES__FUNCTIONS_H_
#define USB_DEVICE_DRIVER__MSG__DETAIL__MOTORS_STATES__FUNCTIONS_H_
 ...
 * calls
 * usb_device_driver__msg__MotorsStates__init().
...
/**
 * It calls
 * usb_device_driver__msg__MotorsStates__fini()
 ...
 * usb_device_driver__msg__MotorsStates__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * usb_device_driver__msg__MotorsStates__Sequence__fini()
 * on the array,
...
#endif  // USB_DEVICE_DRIVER__MSG__DETAIL__MOTORS_STATES__FUNCTIONS_H_
