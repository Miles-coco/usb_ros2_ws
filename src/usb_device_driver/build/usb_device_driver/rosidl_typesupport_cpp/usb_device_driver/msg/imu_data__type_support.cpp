...
static const _IMUData_type_support_symbol_names_t _IMUData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, usb_device_driver, msg, IMUData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, usb_device_driver, msg, IMUData)),
  }
};
...
{
  return &::usb_device_driver::msg::rosidl_typesupport_cpp::IMUData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, usb_device_driver, msg, IMUData)() {
  return get_message_type_support_handle<usb_device_driver::msg::IMUData>();
}
